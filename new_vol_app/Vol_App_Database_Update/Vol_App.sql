...
INSERT INTO `EventDetails` VALUES (1,1,'Pet Adoption Drive','Join us for a pet adoption event to find forever homes for cats and dogs.','Houston Humane Society','1234 Animal St, Houston, TX','2024-08-15','09:00:00','13:00:00',4,'Medium',15),(2,2,'Blood Donation Camp','Donate blood and save lives. Open to all eligible donors.','American Red Cross','5678 Medical Blvd, Houston, TX','2024-08-20','10:00:00','14:00:00',4,'High',20),(3,3,'Book Drive for Schools','Collecting books for underprivileged schools in the area.','Books-For-All','9101 Book Rd, Houston, TX','2024-08-25','08:00:00','12:00:00',4,'Medium',10),(4,4,'Community Cleanup','Help clean up local parks and streets. Bring your own gloves!','Houston Cleaner-Uppers','7890 Park Ave, Houston, TX','2024-09-05','07:00:00','11:00:00',4,'Low',20),(5,5,'Food Distribution Event','Distributing food to those in need in our community.','Houston Food Bank','3456 Food St, Houston, TX','2024-09-10','14:00:00','18:00:00',4,'High',18),(6,16,'Tech for Good Hackathon','A hackathon focused on solving community issues through technology.','Tech Innovators Inc.','1234 Tech Lane, Houston, TX','2024-08-18','09:00:00','17:00:00',8,'High',20),(7,17,'Sustainability Workshop','Learn about sustainable practices and how to implement them.','Green Future Foundation','5678 Green St, Houston, TX','2024-09-12','10:00:00','13:00:00',3,'Medium',12),(8,18,'Health Awareness Fair','A fair to promote health awareness and provide free health checkups.','Community Health Network','9101 Health Blvd, Houston, TX','2024-09-18','09:00:00','14:00:00',5,'Medium',20),(9,19,'Urban Planning Forum','Discussing urban planning initiatives for the future of Houston.','Urban Development Group','7890 Urban St, Houston, TX','2024-09-22','10:00:00','12:00:00',2,'Low',15),(10,20,'Education Seminar','A seminar focused on the importance of education for all.','Education for All Organization','3456 Education Ln, Houston, TX','2024-09-30','11:00:00','15:00:00',4,'High',20);
...
INSERT INTO `UserCredentials` VALUES (1,'Password123!'),(2,'SecurePass!456'),(3,'MyP@ssw0rd'),(4,'Passw0rd!789'),(5,'Passwords14#'),(6,'Idontknow987&'),(7,'HelP@2024'),(8,'Charity$123'),(9,'Qwerty135&'),(10,'Olympics2024!'),(11,'SecureP@ss90'),(12,'TrustyP@ss12'),(13,'Guard!an23'),(14,'Prot3ct#456'),(15,'Sh1eld@789'),(16,'sunshine1!'),(17,'blueberry2024'),(18,'rainbow$2'),(19,'p@ssword1234'),(20,'welcome$2024'),(21,'cryptic9!'),(22,'secure*pass1'),(23,'fastcar2024'),(24,'myp@ssw0rd'),(25,'newpass*2024'),(26,'coffeeLover2024'),(27,'mountain$peak'),(28,'summerVibes1!'),(29,'techGuru$2024'),(30,'happyDance99!');
